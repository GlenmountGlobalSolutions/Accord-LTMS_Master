...
Public Class BizLayer
    ...
    Friend Shared Function GetBroadcastParamValue(ByVal strBPParameterTypeID As String, Optional ByVal strBPID As String = "") As String
        Dim strSQL As String
        Dim strResult As String = ""

        strSQL = "SELECT BroadcastParameterValue FROM tblBroadcastParameters " &
                "WHERE BroadcastPointID = '" & strBPID & "' " &
                "AND BroadcastParameterTypeID = '" & strBPParameterTypeID & "'"
