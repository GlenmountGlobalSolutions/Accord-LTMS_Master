...
Public Class ProductionScheduleExport30
    ...
    Private Sub CreateSpreadsheet(ByVal begDT As String, ByVal BroadcastPointID As String)
        ...
        Try
            ...
            Else
                ...
                strTemplateFilePath = Server.MapPath(Request.ApplicationPath) & "\2Reporting\ProductionScheduleExport30.Excel2000.Template.xls"
                strExportFilePath = Session("UserWorkingDirFileSystem").ToString() & "\ProductionScheduleExport30." & Format(Now(), "MMddyy_HHmmss") & ".xls"
                strConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;" &
                                    "Data Source=" & strExportFilePath & ";" &
