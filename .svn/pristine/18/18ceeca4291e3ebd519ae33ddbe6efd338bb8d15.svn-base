    ...
    <div id="divMainLeftPanel">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div id="cmdPanel">
                    <asp:Button ID="cmdProcess" runat="server" ToolTip="Process selected file." Text="Process Selected KD Plan" CssClass="cmdShowWait"></asp:Button>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                <div id="PlanProperties">
                    ...
                    <asp:Label ID="lblSendDateTitle" runat="server" CssClass="spanLabel">KD Plan Send Date:</asp:Label>
                    <asp:Label ID="lblSendDate" runat="server" CssClass="spanLabel spanValue">asdf</asp:Label>
                    <asp:Label ID="lblNFiles" runat="server" CssClass="spanLabel">KD Plans Found in File: </asp:Label>
                ...
                <div id="MonthSelection">
                    <asp:Label ID="lblNFileDates" runat="server" CssClass="spanLabel">Select Month: </asp:Label> 
                    <asp:ListBox ID="lbNFileDates" runat="server" Width="224px" Height="54px" AutoPostBack="True" CssClass="selectListBox"></asp:ListBox>
                </div>
                <p></p>
                <div id="FileContents">
                    <asp:Label ID="LABEL6" runat="server" CssClass="spanLabel h2">Valid File Contents:</asp:Label>
                    <asp:Label ID="lblAsterick" runat="server" CssClass="spanLabel ui-state-highlight" Width="300px">test</asp:Label>
                    <asp:TextBox ID="tbFileContents" runat="server" Width="664px" Height="300px" TextMode="MultiLine" ReadOnly="True" CssClass="textEntry"></asp:TextBox>
                </div>
                <p></p><p></p>
                <div id="BatchIssues"> 
                    <asp:Label ID="lblIssues" runat="server" Width="660px" CssClass="spanLabel h2">Batch Issues:</asp:Label>                  
                    <asp:TextBox ID="tbIssues" runat="server" Width="664px" Height="66px" TextMode="MultiLine" ReadOnly="True" CssClass="textEntry"></asp:TextBox>
                </div>
