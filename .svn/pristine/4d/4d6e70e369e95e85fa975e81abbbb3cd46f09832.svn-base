...
#Region "Methods"
    ...
    Private Sub populatePrinterDropDown(ByVal theSelectedPrinter As String)
        ...
        Try
            ...
            'ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "printit", "populatePrinter", True)
        Catch ex As Exception
    ...
    Private Function LoadDay() As Boolean
        ...
        intDayID = GetDayID(strDate)
        RevisedDt = Utility.GetMondayOfDate(strDate).Date() 'Get beginning of the week Monday
        strDate = RevisedDt.ToString("MM/dd/yyyy")
                ...
                If (dt.Rows.Count > 0) Then
                    ...
                    For i = 0 To dt.Rows.Count - 1
                        ...
                        If (strShift <> dt.Rows(i)(ProductionSchedule.psGetSchedule.Shift).ToString()) Then
                            ...
                            shiftNode.Text = dt.Rows(i)(ProductionSchedule.psGetSchedule.ShiftSuffix).ToString()
