...
#Region "Events"
    ...
    Private Sub Page_Init(sender As Object, e As System.EventArgs) Handles Me.Init
        Try
            ...
            ' Page.ClientScript.RegisterStartupScript(GetType(Page), "focus", "setFocus(" & lbFileContent.SelectedIndex.ToString() & ")", True)
...
#Region "Dialog modalProcess_.aspx"
    ...
    Public Sub lbFileContent_SelectedIndexChanged1(sender As Object, e As EventArgs) Handles lbFileContent.SelectedIndexChanged
