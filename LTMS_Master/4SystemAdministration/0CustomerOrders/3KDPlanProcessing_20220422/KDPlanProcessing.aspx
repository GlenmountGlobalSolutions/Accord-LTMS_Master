...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="divMainCenterPanel">
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
          <ContentTemplate>                 
                ...
                <div id="FileContent">
                    <asp:Label ID="StartLot" runat="server" CssClass="spanLabel h2" Width="80px">Start Lot:</asp:Label>
                    <asp:Label ID="StartLotValue" runat="server" CssClass="spanLabel h2"></asp:Label>
                    <asp:Label ID="EndLot" runat="server" CssClass="spanLabel h2" Width="75px">End Lot:</asp:Label>  
                    <asp:Label ID="EndLotValue" runat="server" CssClass="spanLabel h2"></asp:Label>
                    <p></p>
                    <asp:TextBox ID="tbSearch" TabIndex="3" runat="server" CssClass="textEntry h3"></asp:TextBox>
                    <asp:Button ID="cmdSearch" runat="server" ToolTip="Enter 12 Character Lot Starting with 4 Digit Year" Text="Search" CssClass="cmdShowWait"></asp:Button> 
                    <asp:Label ID="lblAsterick" runat="server" CssClass="spanLabel ui-state-highlight" Width="300px">test</asp:Label>
                    <asp:ListBox ID="lbFileContent" runat="server" AutoPostBack="true" Width="664px" Height="300px" CssClass="selectListBox0" SelectionMode="Multiple" Font-Names="Courier New"></asp:ListBox>
               </div>
                <p></p> 
                <p></p><p></p>
                <div id="BatchIssues"> 
           ...
           <%-- <Triggers>        
               <asp:PostBackTrigger ControlID="lbFileContent" /> 
            </Triggers>--%>
        </asp:UpdatePanel>       
    </div>
    ...
    <div id="divDialogProcess" title="Confirm Process File">
        <asp:UpdatePanel runat="server">
           ...
           <%-- <Triggers>
               <asp:PostBackTrigger ControlID="cmdProcess" /> 
            </Triggers>--%>
        </asp:UpdatePanel>
    </div>
