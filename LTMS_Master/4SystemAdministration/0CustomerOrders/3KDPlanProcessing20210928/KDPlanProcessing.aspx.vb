...
#Region "Events"
    ...
    Private Sub Page_PreRender(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.PreRender
        Try
            EnableControls()
            ScriptManager.RegisterStartupScript(UpdatePanel2, UpdatePanel2.GetType(), "focus", "setFocus1(" & lbFileContent.SelectedIndex.ToString() & ");", True)
        Catch ex As Exception
            Master.eMsg(ex.ToString())
        End Try
    End Sub
    ...
    Private Sub lbNfiles_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lbNfiles.SelectedIndexChanged
        If lbNfiles.SelectedValue <> "" Then    'make sure an N-value is selected
            ChangeSelectedKDPlan()
            '''pah   ScriptManager.RegisterStartupScript(UpdatePanel2, UpdatePanel2.GetType(), "focus", "setFocus1(" & lbFileContent.SelectedIndex.ToString() & ")", True)
        End If
        ...
        Try
            ...
            Using sWriter As New StreamWriter(path, False)
                ...
                For Each I As Integer In lbFileContent.GetSelectedIndices
                    sWriter.Write(lbFileContent.Items(I).Value.Replace("*", ""))
                Next
            End Using
...
#Region "Dialog modalProcess_.aspx"
    ...
    Private Sub PopulateLabels()
        ...
        EndLotValue.Text = Right(lbFileContent.Items(ii).ToString, 14)
    ...
    Private Sub cmdSearch_Click(sender As Object, e As EventArgs) Handles cmdSearch.Click
        ...
        For idx = 0 To lbFileContent.Items.Count - 1
            ...
            If Right(lbFileContent.Items(idx).Text.Trim, 12) = tbSearch.Text.Trim Then
